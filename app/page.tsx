      ...
      <section className="hero relative min-h-screen flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 w-full h-full hidden md:block">
            <iframe
              src="https://www.youtube.com/embed/Ke_-rOtu5o4?autoplay=1&mute=1&loop=1&playlist=Ke_-rOtu5o4&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1"
          ...
          <div className="absolute inset-0 w-full h-full md:hidden overflow-hidden">
            <iframe
              src="https://www.youtube.com/embed/2_L7WHhDM7E?autoplay=1&mute=1&loop=1&playlist=2_L7WHhDM7E&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1&vq=hd1080"
